...
void setup()
{
	...
	attachInterrupt(digitalPinToInterrupt(BTN_one), buttonProccess, CHANGE); // digital pin 2 // up
	attachInterrupt(digitalPinToInterrupt(BTN_two), buttonProccess, CHANGE); // digital pin 3 // up
